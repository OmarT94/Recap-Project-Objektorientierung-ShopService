...
public class OrdersByStatusTest {
    ...
    @Test
     void testGetOrdersByStatus() {
        ...
        Order order1 = new Order(UUID.randomUUID().toString(), products, OrderStatus.PROCESSING);
        Order order2 = new Order(UUID.randomUUID().toString(), products, OrderStatus.COMPLETED);
        Order order3 = new Order(UUID.randomUUID().toString(), products, OrderStatus.PROCESSING);
